...
<?php
include('C:\laragon\www\ProyectoGrado\template\header.php');
?>
  ...
  <div class="content-header">
    ...
    <section class="content">
        <div class="container-fluid">
            <h2 class="text-center display-4">Proveedores</h2>
...
<!-- /.content-wrapper -->\
<?php
include('C:\laragon\www\ProyectoGrado\template\footer.php');
?>